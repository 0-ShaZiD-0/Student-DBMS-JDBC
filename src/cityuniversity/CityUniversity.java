...
public class CityUniversity extends JFrame {
	static CityUniversity frame;
	...
	public CityUniversity() {
		...
		JLabel lblFeeReport = new JLabel("Student Management");
